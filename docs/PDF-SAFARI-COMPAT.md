...
Publicación: código `628200f`, deploy `2aee0dd`. Se confirmó el asset `index-DGiCsGxs.js` en el sitio público y se ejecutó allí la prueba WebKit con APIs deshabilitadas: 87/87 páginas, 870 fragmentos, cero errores. Evidencia: `pdf-evidence/pdf-compat-public-webkit.json`. Respaldo anterior: `backup/pre-safari-pdf-20260918`. El despliegue web no instala el paquete nativo de Xcode en un teléfono.
